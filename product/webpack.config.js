...
const {NoEmitOnErrorsPlugin, SourceMapDevToolPlugin, NamedModulesPlugin, ExternalsPlugin} = require('webpack');
...
const execPlugin = [
  new ExternalsPlugin('commonjs', ['electron', "child_process", "fs", "os", 'path']),
